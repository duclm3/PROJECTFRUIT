...
<div class="row">
    <div class="col-xs-12">
        <f:form class="form-horizontal" action="updateProduct.htm" commandName="proUpdate" method="POST" >
                <div class="form-group">
                        <f:label path="productId" class="col-sm-2 control-label no-padding-right"  > ID </f:label>
                        <div class="col-sm-10">
                        <f:input path="productId" readonly="true" class="col-xs-10 col-sm-10" />
                        </div>
                </div>
                <div class="form-group">
                        <f:label path="nameProduct" class="col-sm-2 control-label no-padding-right" for="form-field-1"> Name </f:label>
                        <div class="col-sm-10">
                                <f:input  path="nameProduct" placeholder="" class="col-xs-10 col-sm-10" />
                        </div>
                </div>
                <div class="form-group">
                        <f:label  path="price" class="col-sm-2 control-label no-padding-right" for="form-field-1"> Price </f:label>
                        <div class="col-sm-10">
                                <f:input path="price" placeholder="" class="col-xs-10 col-sm-10" />
                        </div>
                </div>
                <div class="form-group">
                        <f:label path="groupProduct.groupId" class="col-sm-2 control-label no-padding-right" for="form-field-1"> Category </f:label>
                        <div class="col-sm-10">
                            <f:select path="groupProduct.groupId" placeholder="" class="col-xs-10 col-sm-10">
                                <option value="${proUpdate.groupProduct.groupId}">${proUpdate.groupProduct.groupName}</option>
                ...
                <div class="form-group">
                        <f:label path="quantity" class="col-sm-2 control-label no-padding-right" for="form-field-1"> Quantity </f:label>
                        <div class="col-sm-10">
                                <f:input path="quantity" placeholder="" class="col-xs-10 col-sm-10" />
                        </div>
                </div>
                <div class="form-group">
