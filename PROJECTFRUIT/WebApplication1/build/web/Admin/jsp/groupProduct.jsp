        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="box-header">
                    ...
                    <br>
                    <div class="row">
                        <div class="col-md-6"><a href="initInsertGroup.htm" class="btn btn-primary">Add</a></div>
                                    ...
                                    <div class="product-essential">
                                        ...
                                        <div class="product-shop col-lg-7 col-sm-7 col-xs-12">
                                            ...
                                            <div class="short-description">
                                                <h2><b style="color: green">Mã&emsp;&emsp;&emsp;&emsp;:</b><span class="modal_idd"></span></h2>
                                                <br>
                                                <h2><b style="color: green">Tình trạng &ensp;:</b>Hiển thị</h2>
                                                <br>

                                                <h2><b style="color: green">Mô tả   &emsp;&emsp;&ensp;:</b> <span class="modal_des"></span></h2>
                                                <br>
                                            </div>
...
<![endif]-->
                ...
                <script type="text/javascript">
                    ...
                    var allproductx = [
                    <c:forEach items="${listGroup}" var="pro">
                        {
                            id:"${pro.groupId}",
                                    name: "${pro.groupName}",
                            price:"${pro.groupStatus}",
                                    image:"${pro.imageLink}",
                    ...
                    $(function () {
                        $(".link-quickview").click(function () {
                            ...
                            var _product = (allproductx.filter(function (p) {
                                return p.id == _id
                            }))[0];
