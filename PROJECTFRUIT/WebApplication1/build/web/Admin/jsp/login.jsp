						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Fruit</span>
									<span class="white" id="id-text2">Store</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; TAD company</h4>
							</div>
                                                    <br>
                                                    <br>
                                                    <br>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-left">
                                                                                                                    <input name="email" placeholder="Email@gmail.com" style="width: 282px;padding-left: 40px;"/><span class="required" style="color: red">*</span>
													...
													<div class="clearfix">
														...
														<button  id="send2" name="send" type="submit" class="width-35 position-relative btn btn-sm btn-primary">
