        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <f:form class="form-horizontal"  action="insert.htm" commandName="newPro">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" > ID </label>

                                <div class="col-sm-10">
                                    <f:input path="productId"  class="col-xs-10 col-sm-10" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Quantity </label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Descriptions </label>
...
<![endif]-->
                <script type="text/javascript">
                    if ('ontouchstart' in document.documentElement)
                        document.write("<script src='../Admin/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
                </script>
